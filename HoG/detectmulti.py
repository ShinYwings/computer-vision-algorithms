...
parser.add_argument('-n', '--nms_threshold', help="Threshold Values between 0 to 1 for NMS thresholding. Default is 0.5", default=0.5, type=float)
...
while (h >= 128 and w >= 64):
    ...
    while i < vert:
        ...
        while j < horiz:
            ...
            features = hog(portion, orientations=9, pixels_per_cell=(8, 8), cells_per_block=(2, 2), block_norm="L2-Hys")
